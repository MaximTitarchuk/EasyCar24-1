...
$(document).ready(function () {
    ...
    $(".addBtn").click(function () {
        $("#edit h3").html("Добавить страницу");
        $.each($("#edit input,textarea"), function (idx, obj) {
    ...
    $("#list").on("click", ".removeBtn", function () {
        $(".removeConfirmBtn").attr("data-id", $(this).data("id"));
        $("#remove").modal("show");
    });
            ...
            .done(function( data ) {
                $.each(data, function(field, value) {
                    if (value !== null) {
                        ...
                        else if ($("#" + field).is("input[type='text']") || $("#" + field).is("input[type='email']") || $("#" + field).is("input[type='url']"))
                            $("#" + field).val(value);
